...
<body class="font-['Inter'] antialiased bg-slate-50 h-screen overflow-hidden flex">
    ...
    <aside class="w-64 sidebar-gradient text-white flex flex-col shrink-0 shadow-xl shadow-indigo-500/10 h-full">
        ...
        <nav class="px-3 py-4 space-y-0.5 text-sm sidebar-nav" style="overflow-y: scroll; height: calc(100vh - 128px);">
            ...
            @endcanAccessMenu
            @canAccessMenu('accounting-periods.index')
            ...
            @endcanAccessMenu
            @canAccessMenu('opening-balances.index')
            ...
            @canAccessMenu('journal-entries.index')
            ...
            @canAccessMenu('fixed-assets.index')
            ...
            @endcanAccessMenu
            @canAccessMenu('arap.kartu-piutang')
            ...
            @endcanAccessMenu
            @canAccessMenu('arap.kartu-hutang')
            ...
            @endcanAccessMenu
            @canAccessMenu('overtime-requests.index')
            <x-nav-link :href="route('overtime-requests.index')" :active="request()->routeIs('overtime-requests.*')" class="nav-link text-white/80 hover:text-white"><svg class="w-4 h-4 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Overtime (WH)</x-nav-link>
            @endcanAccessMenu
            @canAccessMenu('loans.index')
            ...
            @endcanAccessMenu
            @canAccessMenu('attendances.index')
            ...
            @endcanAccessMenu
            @canAccessMenu('employee-salaries.index')
            ...
            @endcanAccessMenu
            @canAccessMenu('cash-advances.index')
            ...
            @endcanAccessMenu
            @canAccessMenu('exchange-rates.index')
            ...
            @canAccessMenu('reports.general-ledger')
            ...
            @endcanAccessMenu
            @canAccessMenu('reports.trial-balance')
            ...
            @endcanAccessMenu
            @canAccessMenu('reports.income-statement')
            ...
            @endcanAccessMenu
            @canAccessMenu('reports.balance-sheet')
            ...
            @endcanAccessMenu
            @canAccessMenu('reports.financial-highlight')
            ...
            @if(auth()->user()?->isAdmin())
                ...
                <x-nav-link :href="route('data-reset.index')" class="nav-link text-white/80 hover:text-white"><svg class="w-4 h-4 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>Reset Data</x-nav-link>
            @endif
        </nav>
